...
def run_test_make_simple_string():
    ...
    # Test 2:
    expected = '10-11-12-13-'
    actual = make_simple_string(10, 13)
    print('Expected:', expected)
    print('Actual:  ', actual)
    # Test 3:
    expected = '1-2-3-4-5-'
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '10-11-12-13'
    actual = make_less_simple_string(10, 13)
    print('Expected:', expected)
    print('Actual:  ', actual)
    # Test 3:
    expected = '1-2-3-4-5'
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        circle=circles[k]
        p1=rg.Point((circle.center.x-circle.radius),(circle.center.y+circle.radius))
        p2=rg.Point((circle.center.x+circle.radius),(circle.center.y-circle.radius))
        rectangles=rectangles+[rg.Rectangle(p1,p2)]
    return rectangles
